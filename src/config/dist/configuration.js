...
exports["default"] = (function () {
    return {
        ...
        runMode: process.env.RUN_MODE || 'node',
        ...
        orbitdb: {
            ...
            databases: {
                ...
                pending_multisig_tx_witnesses: process.env.PENDING_MULTISIG_TX_WITNESSES_DATABASE ||
                    'pending_multisig_tx_witnesses',
                pending_multisig_txs: process.env.PENDING_MULTISIG_TXS_DATABASE || 'pending_multisig_txs',
                steps: process.env.STEPS_DATABASE || 'steps',
                step_transactions: process.env.STEP_TRANSACTIONS_DATABASE || 'step_transactions',
